...
function initPage() {
    ...
    metaInfo = getPracticalInfo(); //should be provided in app.js
    if (!metaInfo)
    ...
    mainTitle.textContent = "Information Visualization- Icicle Plots";
    main.appendChild(mainTitle);

    document.title = "Information Visualization- Icicle Plots";
...
function start() {
    ...
    draw(two, getData(), params.width, params.height);
